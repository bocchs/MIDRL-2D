...
__all__ = ['MaxPooling2D', 'AvgPooling2D', 'GlobalAvgPooling2D',
...
def MaxPooling2D(x, shape, stride=None, padding='VALID', data_format='NDHWC'):
    """
...
# AB
@layer_register(log_shape=True)
def AvgPooling2D(x, shape, stride=None, padding='VALID', data_format='NDHWC'):
    """
...
# AB
@layer_register(log_shape=True)
def GlobalAvgPooling2D(x, data_format='NDHWC'):
    """
